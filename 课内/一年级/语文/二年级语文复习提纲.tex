...
\textbf{备选词语：}
\begin{center}
    因为……所以…… \quad 一边……一边…… \quad 虽然……但是…… \quad 一……就…… \\
    如果……就…… \quad 只要……就…… \quad 先……再…… \quad 不但……而且…… \\
    有的……有的……还有的……
\end{center}
...
\begin{enumerate}
    ...
    \item 弟弟（ \hspace{2cm} ）跑步，（ \hspace{2cm} ）听音乐。
    \item 奶奶（ \hspace{2cm} ）织毛衣，（ \hspace{2cm} ）和我们聊天。
    \item （ \hspace{2cm} ）天黑了，（ \hspace{2cm} ）我们要回家了。
    \item 树叶（ \hspace{2cm} ）变黄了，（ \hspace{2cm} ）秋天到了。
    \item （ \hspace{2cm} ）雨下得很大，（ \hspace{2cm} ）同学们还是准时到校了。
    \item （ \hspace{2cm} ）我很想去玩，（ \hspace{2cm} ）作业还没写完。
    \item 妈妈（ \hspace{1.5cm} ）看到我考了满分，（ \hspace{1.5cm} ）高兴地笑了。
    \item 春风（ \hspace{1.5cm} ）吹，花儿（ \hspace{1.5cm} ）开了。
    \item 果园里，（ \hspace{1.5cm} ）是苹果，（ \hspace{1.5cm} ）是梨，（ \hspace{1.5cm} ）是葡萄。
    \item 这里的书真多，（ \hspace{1.5cm} ）是童话书，（ \hspace{1.5cm} ）是故事书，（ \hspace{1.5cm} ）是漫画书。
    \item （ \hspace{2cm} ）我也能像孙悟空一样七十二变，那（ \hspace{2cm} ）太好了。
    \item （ \hspace{2cm} ）这周末天气好，爸爸（ \hspace{2cm} ）带我去钓鱼。
    \item （ \hspace{2cm} ）你认真听讲，（ \hspace{2cm} ）能听懂老师的话。
    \item （ \hspace{2cm} ）平时多积累，写作文（ \hspace{2cm} ）不难了。
    \item 吃饭前，要（ \hspace{2cm} ）洗手，（ \hspace{2cm} ）吃饭。
    \item 我（ \hspace{2cm} ）把作业写完，（ \hspace{2cm} ）出去玩。
    \item 这座桥（ \hspace{2cm} ）坚固，（ \hspace{2cm} ）美观。
    \item 苹果（ \hspace{2cm} ）好看，（ \hspace{2cm} ）好吃。
\end{enumerate}
